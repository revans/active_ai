module ActiveAI
  ...
  # inherit run from Base, workflows from Workflow. Regular tools (Tool::Base
  # subclasses) can also be registered via the
  # inherited tool() DSL from ActiveAI::Base alongside agent/workflow meta-tools.
  #
  ...
  #
  class Orchestrator < ActiveAI::Base
    ...
    def self.agent(agent_class, description: agent_class._description, context: nil)
      ...
      unless agent_class.respond_to?(:run)
        raise ArgumentError,
          ...
          "Classes inheriting ApplicationAgent get this automatically via ActiveAI::Base."
      end
    ...
    def self.workflow(workflow_class, description: workflow_class._description, context: nil)
      ...
      unless workflow_class.respond_to?(:run)
        raise ArgumentError,
          ...
          "Classes inheriting ApplicationWorkflow get this automatically via ActiveAI::Workflow."
      end
